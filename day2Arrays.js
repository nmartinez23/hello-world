...
var treasureChest = ['fur jackets']

treasureChest[0] = 'ethically sourced sandals';
//console.log(treasureChest.length);

treasureChest.push('friends')
treasureChest[2] = 'gold';
treasureChest[treasureChest.length] = 'pearls';
treasureChest.push('silver')
//console.log(treasureChest);

//var jacket = treasureChest[0] access test
//console.log(jacket);

//console.log(treasureChest.pop());  //silver

treasureChest.unshift('parrot')
//console.log(treasureChest);

//console.log(treasureChest.shift()); //parrot
...
var Unicorn = {
  type: 'unicorn',
  collects: ['berries', 'grass', 'leaves'],
  canFly: true
}

var Dinosaurs = {
  type: 'dinosaur',
  collects: ['goats', 'villagers', 'gold'],
  canFly: true
}

var polarBear = {
  type: 'polar bear',
  collects: ['seals', 'penguins', 'hunters'],
  canFly: false
}

grandCouncil[0] = Unicorn;
grandCouncil[grandCouncil.length] = Dinosaurs;
grandCouncil.push(polarBear);  
