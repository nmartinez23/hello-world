...
treasureChest = ['ethically sourced sandals'];
...
treasureChest.push('shovel');
treasureChest.push('gold');
...
grandCouncil [grandCouncil.length] = horseBone;
grandCouncil [1] = franz;
grandCouncil.push ('open position available');
...
var mysticalAnimal = { 
  type: 'dragon',                                                                                   name: 'Leslie',                                                                                   likes: [],                                                                                       bestfriend: 'Raphael',                                                                           superpower: 'gives amazing hugs',                                                                 food: 'BBQ',                                                                                     canFly: true,                                                                                     collects: 'diamonds and gold and fire extinguishers' }    
